...
import $css_2 from 'Frontend/styles/views/cardlist/card-list-view.css';
addCssBlock(`<custom-style><style include="lumo-badge">${$css_2}</style></custom-style>`);
import $css_3 from 'Frontend/styles/views/creditcardform/credit-card-form-view.css';
addCssBlock(`<custom-style><style>${$css_3}</style></custom-style>`);
import $css_4 from 'Frontend/styles/views/personform/person-form-view.css';
addCssBlock(`<custom-style><style>${$css_4}</style></custom-style>`);
import $css_5 from 'Frontend/styles/views/addressform/address-form-view.css';
addCssBlock(`<custom-style><style>${$css_5}</style></custom-style>`);
import $css_6 from 'Frontend/styles/views/masterdetail/master-detail-view.css';
