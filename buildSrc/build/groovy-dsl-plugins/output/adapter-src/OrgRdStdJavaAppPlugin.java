...
/**
 * Precompiled org.rd.std.java-app script plugin.
 **/
public class OrgRdStdJavaAppPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_OrgRdStdJavaApp").asSubclass(BasicScript.class);
