...
/**
 * Precompiled org.rd.std.java-library script plugin.
 **/
public class OrgRdStdJavaLibraryPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_OrgRdStdJavaLibrary").asSubclass(BasicScript.class);
