...
/**
 * Precompiled org.rd.std.java-common script plugin.
 **/
public class OrgRdStdJavaCommonPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_OrgRdStdJavaCommon").asSubclass(BasicScript.class);
